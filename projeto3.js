...
do {
   ...
   ciclo1: do {
    ...
    if(decisao2==0){
        ...
        console.log();
        console.log("O dragão acaba limpando o dente com a pequena Évy (não da para encher a barriga com uma garota que tem menos de 1,60);");
        statusJogador.vit=0
        console.log(`Vitalidade: ${statusJogador.vit}`)
        separacao = prompt("")
    ...
    //ciclo da tarde
     ciclo2: while(statusJogador.dia==1){
        ...
        let decisao4 = prompt("Deseja ajudar o velho?(s/n): ");
        while(decisao4!="s" && decisao4!="n"){
            console.log("Responda apenas com 's' ou 'n'")
            decisao4 = prompt("Deseja ajudar o velho?(s/n): ");
        }
     }
